...
async function main() {
    console.log('\n============================================================');
    console.log('🔴 CLOSING BNB FUTURES POSITION (From PositionRisk)');
    console.log('============================================================\n');

    try {
        const riskData = await getPositionRisk('BNBUSDT');
        ...
        const newRiskData = await getPositionRisk('BNBUSDT');
        let stillOpen = 0;
        ...
        if (stillOpen === 0) {
            ...
            console.log(`⚠️ Position still open (${stillOpen} position)\n`);
        }
